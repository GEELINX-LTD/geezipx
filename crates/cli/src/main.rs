...
enum Commands {
    ...
    Compress {
        ...
        /// Archive format: zip, jar, war, apk, ipa, xpi, tar, tar.gz, tgz, tar.bz2, tbz, tbz2, gz, gzip, bz2, bzip2, zst, zstd, tar.zst, tzst, tar.xz, txz, xz, lzma (default: derived from output extension or zip)
        ...
        /// Compression level (0-22, default: varies; gzip/bzip2/tar.gz/tar.bz2/xz/lzma/tar.xz: 0..=9, zstd/tar.zst: 0..=22; bzip2/tar.bz2 level 0 maps to default)
        ...
        /// Read uncompressed data from stdin (single-stream and tar-based formats: gzip, bzip2, zstd, xz, lzma, tar.gz, tar.bz2, tar.zst, tar.xz)
        #[arg(long = "stdin")]
        stdin: bool,

        /// Write compressed data to stdout (single-stream and tar-based formats: gzip, bzip2, zstd, xz, lzma, tar.gz, tar.bz2, tar.zst, tar.xz)
        #[arg(long = "stdout")]
        stdout: bool,
    },
    ...
    Decompress {
        ...
        /// Decompress to stdout (gzip/bzip2/zstd/xz/lzma/tar.gz/tar.bz2/tar.zst/tar.xz only; error for multi-file archives other than tar-wrapped raw-stream output)
        #[arg(long = "stdout")]
        stdout: bool,
        ...
        /// Read compressed data from stdin (single-stream and tar-based formats: gzip, bzip2, zstd, xz, lzma, tar.gz, tar.bz2, tar.zst, tar.xz)
        #[arg(long = "stdin")]
        stdin: bool,
